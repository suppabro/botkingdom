...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.ulangTahun = `අඩුවෙන් ${ohari} දින ${ojam} පැය ${onet} විනාඩි ${detek}🥰`
        global.tahunBaru = `${jhari} දින ${jjam} පැය ${mmmenit} විනාඩි ${ddetik}  🥳`
        ...
        global.docux = img
        global.nd = pickRandom(['@supuna', 'supuna', 'supuna'])
        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.limit)) user.limit = 2000
            ...
            case 'remove':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = 'https://telegra.ph/file/add1965ec2202c34eaa40.jpg-s1068-b1'
                        try {
                            ...
                            this.sendBD(id, text, wm, pp, [[`Menu`, `.menu`], [action === 'add' ? 'Welcome 🙏' : 'Goodbye 👋', '@rasel.ganz']], {                      
                              ...
                              { 
                               jpegThumbnail: await (await fetch("https://telegra.ph/file/add1965ec2202c34eaa40.jpg-s1068-b1")).buffer(), fileName: action === 'add' ? `Welcome ${this.getName(user)} ` : `Goodbye ${this.getName(user)} `, mimetype: global.td, fileLength: global.fsdx, pageCount: global.pcdx,
                               mentions: [user],
                               contextInfo: {
                               externalAdReply :{
                                  mediaUrl: linkig,
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: `ඔව්නර්ට පමනි @${global.owner[0]}`,
        owner: `බොසාට විතරයි 🙂 @${global.owner[0]}`,
        mods: `only Moderator`,
        moderator: `only Moderator`,
        prems: `only Premium`,
        premium: `only Premium`,
        group: `only Grup`,
        private: `only pc @${conn.user.jid.split('@')[0]}`,
        admin: `මෙම විධානය කණ්ඩායම් පරිපාලක සඳහා පමණි`,
        botAdmin: `bot පරිපාලක වූ විට මෙම විධානය සක්‍රීය වේ`,
        unreg: `Belum Terdaftar, Silahkan Daftar Dengan Mengetik #daftar nama.umur`,
        dewasa: `ADULT විශේෂාංගය සක්‍රිය නැත, කරුණාකර එය සක්‍රිය කිරීමට හිමිකරු අමතන්න`,
        nsfw: `NSFW විශේෂාංගය සක්‍රිය නැත, කරුණාකර එය සක්‍රිය කිරීමට හිමිකරු අමතන්න`,
        game: `GAME විශේෂාංගය සක්‍රිය නැත, කරුණාකර එය සක්‍රිය කිරීමට හිමිකරු අමතන්න`,
        rpg: `RPG විශේෂාංග සක්‍රිය නැත, කරුණාකර එය සක්‍රිය කිරීමට හිමිකරු අමතන්න`,
        restrict: `පරිපාලක විශේෂාංගය සක්‍රිය නැත, කරුණාකර එය සක්‍රිය කිරීමට හිමිකරු අමතන්න`,
      }[type]
...
global.tmbnld = [
    'https://telegra.ph/file/ab9b0b87b770d32548182.jpg',
]

global.tmbnlm = [
    'https://telegra.ph/file/add1965ec2202c34eaa40.jpg',
    'https://telegra.ph/file/add1965ec2202c34eaa40.jpg',
    'https://telegra.ph/file/add1965ec2202c34eaa40.jpg',
    'https://telegra.ph/file/add1965ec2202c34eaa40.jpg',
    'https://telegra.ph/file/add1965ec2202c34eaa40.jpg',
